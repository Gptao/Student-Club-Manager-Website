...
<c:if test="${empty sessionScope.DepartmentList}">
	<jsp:forward page="Department_findAll"></jsp:forward>
</c:if>
			...
			<div class="container">
				<div class="contact">
					<h3 class="wow bounceIn" data-wow-delay="0.4s">报名表</h3>
						<form class="wow bounceIn" data-wow-delay="0.4s" action="Member_add" method="post">
						   学&nbsp;&nbsp;&nbsp;&nbsp;号 <input type="text" style="width: 45%;" name="memberId" value="${requestScope.register.registerId}">
							姓名 <input type="text" style="width: 45%;" name="memberName" value="${requestScope.register.registerName}">
							<input type="hidden"  name="memberPassword" value="${requestScope.register.registerPassword}">
							<br/>
						
							性&nbsp;&nbsp;&nbsp;&nbsp;别 <input type="text" style="width: 45%;" list="itemlist1"  name="memberGender" value="${requestScope.register.registerGender}">
							        <datalist id="itemlist1">
                                    <option value="男">男</option>
                                    <option value="女">女</option>
                                    </datalist>
							籍贯 <input type="text" style="width: 45%;" list="itemlist2"  name="memberHometown" value="${requestScope.register.registerHometown}">
								...
								联系电话 <input type="text"  style="width: 45%;" name="memberPhone" value="${requestScope.register.registerPhone}">
							专业 <input type="text" list="itemlist4"  style="width: 45%;" name="memberMajor" value="${requestScope.register.registerMajor}"><br/>
							...
							报名时间 <input type="date" style="border: 1px solid #DCDCDF;
								  ...
								  -weblit-border-radius: 0.3em;" name="time" value="${requestScope.register.registerDate}"/>
