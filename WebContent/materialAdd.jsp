...
<c:if test="${empty requestScope.orgPage.dataList}">
	<jsp:forward page="Org_showAllForMaterialAdd"></jsp:forward>
</c:if>
<body>
<!-- 标题头  -->
...
<!--start-contact-->
		<div class ="contact-section">
			<div class="container">
				<div class="contact">
					<h3 class="wow bounceIn" data-wow-delay="0.4s">新添物品</h3>
					<p class="wow fadeInUpBig animated" data-wow-delay="0.4s">物品描述</p>
						
						<form action="material_add" method="post" class="wow bounceIn" data-wow-delay="0.4s">
							...
							<input type="text" name="materialName" placeholder="物品名" value="${requestScope.material.materialName}">
						 	...
						 	<input type="text" name="organization.organizationId" list="itemlist10" placeholder="所属组织" value="${requestScope.material.organization.organizationId}">
						 	...
						 	<textarea name="materialRemarks" placeholder="备注" value="${requestScope.material.materialRemarks}"></textarea>
