			...
			<!-- <div class="col-md-9 single-page"> -->
				...
				<div class="single-content">
					<div class="single">
						...
						<!-- 表单 -->
						<form id="commentform" class="wow fadeInRight animated" data-wow-delay="0.4s" action="Act_add" method="post">
							 ...
							 <p class="comment-form-pic">
							 	<label for="activityPicture" align="left">选择需要上传的图片</label>
   								<!-- <input type="file" name="fileField" class="file" id="fileField" onchange="document.getElementById('textfield').value=this.value" name="picIntroduction"/> -->
